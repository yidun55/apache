 ...
 */
public class BigCursor {
    private static final Logger LOG = LoggerFactory.getLogger(lakala.sjb.flume.tail.util.BigCursor.class);
    ...
    public BigCursor(BlockingQueue<Event> sync, File f) {
        this(sync, f, 0, 0, 0);
    }

    public BigCursor(BlockingQueue<Event> sync, File f, long lastReadOffset, long lastFileLen, long lastMod) {
        this.sync = sync;
        this.file = f;
    ...
    public void flush() throws InterruptedException {
        ...
        if (remaining > 0) {
            ...
            headers.put(lakala.sjb.flume.tail.source.safetyTailSource.A_TAILSRCFILE, file.getName());
     ...
     */
    public void resetRAF() throws InterruptedException {
