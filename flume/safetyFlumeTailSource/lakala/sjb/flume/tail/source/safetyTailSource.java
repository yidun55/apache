package lakala.sjb.flume.tail.source;
...
import lakala.sjb.flume.tail.util.Clock;
import lakala.sjb.flume.tail.util.BigCursor;

/**
 * Created by dyh on 2016/8/2.
 */
public class safetyTailSource extends AbstractSource implements Configurable, PollableSource {

    private static final Logger LOG = LoggerFactory.getLogger(safetyTailSource.class);
    ...
    final List<BigCursor> cursors = new ArrayList<BigCursor>();
    private final List<BigCursor> newCursors = new ArrayList<BigCursor>();
    private final List<BigCursor> rmCursors = new ArrayList<BigCursor>();
    ...
    public void configure(Context context) {
        ...
        BigCursor c = new BigCursor(sync, f, readOffset, fileLen, modTime);
        addCursor(c);
    }
    ...
    synchronized void addCursor(BigCursor cursor) {
     ...
     */
    synchronized public void removeCursor(BigCursor cursor) {
        if (thd == null) {
